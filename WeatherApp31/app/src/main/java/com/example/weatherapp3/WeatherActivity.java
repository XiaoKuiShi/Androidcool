...
import com.example.weatherapp3.json.Forecast;
import com.example.weatherapp3.json.Weather;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    void requestWeather(String weatherId) {
        String url ="http://guolin.tech/api/weather?cityid=" + weatherId + "&key=53c624ba41b4419caca45abd219a0f94";
